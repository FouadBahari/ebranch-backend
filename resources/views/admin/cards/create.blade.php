...
@section('title',"اضافة كروت الشحن")
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.cards')}}"> كروت الشحن </a>
                                ...
                                <li class="breadcrumb-item active">اضافة كروت الشحن
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">اضافة كروت الشحن </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.cards.store')}}"
                                            method="POST">
                                            @csrf
                                            <div class="form-body">
