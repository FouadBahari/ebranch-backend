                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.reasons')}}">   الاسباب </a>
                                ...
                                <li class="breadcrumb-item active">إضافة الاسباب
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة  الاسباب </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.reasons.store')}}"
                                            method="POST">
                                            @csrf
                                            <div class="form-body">
