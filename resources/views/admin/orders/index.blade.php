                                        ...
                                        <table
                                            ...
                                            @isset($orders )
                                                @foreach($orders  as $order )
                                                    <tr>
                                                        <td>{{ $order -> id}}</td>
                                                        <td>@foreach ($order-> products as $index=>$product)
                                                            {{$product->name}} | {{explode(',',$order->amount)[$index]}} <br>
                                                        @endforeach</td>
                                                        <td>{{$order->price}}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <a href="" data-toggle="modal" data-target="#exampleModal{{$order->id}}"
                                                                    class="btn btn-outline-primary btn-sm box-shadow-3 mr-1 mb-1">تفاصيل</a>

                                                                <a href="{{route('admin.orders.status',['finished',$order->id])}}"
                                                                    class="btn btn-outline-primary btn-sm box-shadow-3 mr-1 mb-1">مخالصة</a>
                                                            </div>
                                                            <!-- Modal -->
